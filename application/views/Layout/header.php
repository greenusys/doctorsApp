		...
		<div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li class="menu-title">Doctors Section</li>
                        <li class="active">
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								<li><a href="<?=base_url('Doctors/addDCSection')?>"><i class="fa fa-plus-circle" aria-hidden="true"></i>Add Doctors</a></li>
								<li><a href="<?=base_url('Doctors/viewDCSection')?>"><i class="fa fa-eye" aria-hidden="true"></i> Doctors</a></li>
